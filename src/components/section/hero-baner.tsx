...
const HeroBaner = () => {
    return (
        <div className={"bg-[#FFF8F1] mt-[80px] rounded-[20px] md:grid md:grid-cols-2 md:justify-between xs:flex xs:flex-col xs:justify-center xs:items-center xs:text-center"}>
